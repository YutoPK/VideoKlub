...
{
 $sql_query="DELETE FROM clanarina WHERE idClanarine=".$_GET['delete_id'];
    ...
    <script type="text/javascript">
        function edt_id(id){
            if(confirm('Sigurni ste da zelite promenu podataka ?')){
                window.location.href='clanarina_editdata.php?edit_id='+id;
            }
        }
        function delete_id(id){
            if(confirm('Da li sigurno zelite da obrisete podatak ?')){
                window.location.href='clanarina.php?delete_id='+id;
            }
        }
    </script>
</head>
...
<div id="body">
    <div id="content">
        <table align="center">
            <tr>
            <th colspan="5"><a class="orangeColor"href="clanarina_adddata.php">Dodaj podatak</a></th>
            </tr>
            <th>idClanarine</th>
            <th>datumPocetka</th>
            <th>datumIsteka</th>
