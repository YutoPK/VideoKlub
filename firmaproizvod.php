...
{
 $sql_query="DELETE FROM firmaproizvod WHERE idFirmaProizvoda=".$_GET['delete_id'];
    ...
    <script type="text/javascript">
        function edt_id(id){
            if(confirm('Sigurni ste da zelite promenu podataka ?')){
                window.location.href='firmaproizvod_editdata.php?edit_id='+id;
            }
        }
        function delete_id(id){
            if(confirm('Da li sigurno zelite da obrisete podatak ?')){
                window.location.href='firmaproizvod.php?delete_id='+id;
            }
        }
    </script>
</head>
...
<div id="body">
    <div id="content">
        <table align="center">
            <tr>
            <th colspan="5"><a class="orangeColor"href="firmaproizvod_adddata.php">Dodaj podatak</a></th>
            </tr>
            <th>idFirmaProizvoda</th>
            <th>idFirma</th>
            <th>idProizvoda</th>
