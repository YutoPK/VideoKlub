...
{
 $sql_query="DELETE FROM clankluba WHERE idClanaKluba=".$_GET['delete_id'];
    ...
    <script type="text/javascript">
        function edt_id(id){
            if(confirm('Sigurni ste da zelite promenu podataka ?')){
                window.location.href='clankluba_editdata.php?edit_id='+id;
            }
        }
        function delete_id(id){
            if(confirm('Da li sigurno zelite da obrisete podatak ?')){
                window.location.href='clankluba.php?delete_id='+id;
            }
        }
    </script>
</head>
...
<div id="body">
    <div id="content">
        <table align="center">
            <tr>
            <th colspan="7"><a class="orangeColor"href="clankluba_adddata.php">Dodaj podatak</a></th>
            </tr>
            <th>idClanaKluba</th>
            <th>idFirma</th>
            <th>ime</th>
