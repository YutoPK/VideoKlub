...
$sql_query="SELECT * FROM clanarina";
$result = mysqli_query($con,$sql_query);

 $idClanarine = mysqli_num_rows($result) + 1;
 $datumPocetka = $_POST['datumPocetka'];
 $datumIsteka = $_POST['datumIsteka'];
 
 // sql query for inserting data into database
 $sql_query = "INSERT INTO clanarina(idClanarine,datumPocetka,datumIsteka) VALUES('$idClanarine','$datumPocetka','$datumIsteka')";
 // sql query for inserting data into database
...
<div id="body">
 <div id="content">
    ...
    <table align="center">
    <tr>
    <td align="center"><a href="clanarina.php" class="orangeColor">Povratak na glavnu stranicu</a></td>
    </tr>
    <tr>
    <td><input type="text" name="datumPocetka" placeholder="datumPocetka" required /></td>
    </tr>
    <tr>
    <td><input type="text" name="datumIsteka" placeholder="datumIstekas" required /></td>
    </tr>
    <tr>
