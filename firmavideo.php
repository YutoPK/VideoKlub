...
{
 $sql_query="DELETE FROM firmavideo WHERE idFirma=".$_GET['delete_id'];
    ...
    <script type="text/javascript">
        function edt_id(id){
            if(confirm('Sigurni ste da zelite promenu podataka ?')){
                window.location.href='firmavideo_editdata.php?edit_id='+id;
            }
        }
        function delete_id(id){
            if(confirm('Da li sigurno zelite da obrisete podatak ?')){
                window.location.href='firmavideo.php?delete_id='+id;
            }
        }
    </script>
</head>
...
<div id="body">
    <div id="content">
        <table align="center">
            <tr>
            <th colspan="5"><a class="orangeColor"href="firmavideo_adddata.php">Dodaj podatak</a></th>
            </tr>
            <th>idFirme</th>
            <th>Naziv</th>
            <th>netovrednost</th>
