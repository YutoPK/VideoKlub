...
{
 $sql_query="DELETE FROM radnjafirme WHERE idRadnje=".$_GET['delete_id'];
    ...
    <script type="text/javascript">
        function edt_id(id){
            if(confirm('Sigurni ste da zelite promenu podataka ?')){
                window.location.href='radnjafirme_editdata.php?edit_id='+id;
            }
        }
        function delete_id(id){
            if(confirm('Da li sigurno zelite da obrisete podatak ?')){
                window.location.href='radnjafirme.php?delete_id='+id;
            }
        }
    </script>
</head>
...
<div id="body">
    <div id="content">
        <table align="center">
            <tr>
            <th colspan="8"><a class="orangeColor"href="radnjafirme_adddata.php">Dodaj podatak</a></th>
            </tr>
            <th>idRadnje</th>
            <th>idFirma</th>
            <th>nazivUlice</th>
