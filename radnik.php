...
{
 $sql_query="DELETE FROM radnik WHERE idRadnika=".$_GET['delete_id'];
    ...
    <script type="text/javascript">
        function edt_id(id){
            if(confirm('Sigurni ste da zelite promenu podataka ?')){
                window.location.href='radnik_editdata.php?edit_id='+id;
            }
        }
        function delete_id(id){
            if(confirm('Da li sigurno zelite da obrisete podatak ?')){
                window.location.href='radnik.php?delete_id='+id;
            }
        }
    </script>
</head>
...
<div id="body">
    <div id="content">
        <table align="center">
            <tr>
            <th colspan="9"><a class="orangeColor"href="radnik_adddata.php">Dodaj podatak</a></th>
            </tr>
            <th>idRadnika</th>
            <th>idFirma</th>
            <th>idPozicije</th>
