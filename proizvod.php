...
{
 $sql_query="DELETE FROM proizvod WHERE idProizvoda=".$_GET['delete_id'];
    ...
    <script type="text/javascript">
        function edt_id(id){
            if(confirm('Sigurni ste da zelite promenu podataka ?')){
                window.location.href='proizvod_editdata.php?edit_id='+id;
            }
        }
        function delete_id(id){
            if(confirm('Da li sigurno zelite da obrisete podatak ?')){
                window.location.href='proizvod.php?delete_id='+id;
            }
        }
    </script>
</head>
...
<div id="body">
    <div id="content">
        <table align="center">
            <tr>
            <th colspan="6"><a class="orangeColor"href="proizvod_adddata.php">Dodaj podatak</a></th>
            </tr>
            <th>idProizvoda</th>
            <th>naziv</th>
            <th>opis</th>
